...
export default class Policies extends React.Component {
    render() {
        return (
            <div style={{margin: 5, marginTop: '8vh'}}>
                <h2>Privacy Policy</h2> <p>
                MoverUp LLC built the MoverUp app as
                a Free app. This SERVICE is provided by
                MoverUp LLC at no cost and is intended for
                use as is.
                ...
                MoverUp unless otherwise defined in this Privacy
                Policy.
                </p> <p><strong>Information Collection and Use</strong></p> <p></p>
                For a better experience, while using our Service,
                we may require you to provide us with certain
                personally identifiable information, including but not limited to email, address, location, phone number, profile picture. The
                ...
                are stored on your device's internal memory.<br />
